...
.PHONY: default audit audit-docker audit-npm build clean help init license-check-docker license-check-npm lint lint-docker lint-md notice-npm sbom test update-test-snapshots
